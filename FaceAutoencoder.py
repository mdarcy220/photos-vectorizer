...
act1 = C.ops.tanh(fc1)  #C.ops.param_relu(C.ops.parameter(shape=1024), fc1)
...
input_imgs_raw = [scipy.ndimage.io.imread(file)[50:-50,50:-50] for file in input_img_filenames[:200]]
...
lr_schedule = C.learning_rate_schedule([learning_rate * (0.97**i) for i in range(30)], C.UnitType.sample, epoch_size=1200)
...
print(lookup_img(input_imgs_reshaped[4], k_max=6))
